...
namespace APIEcommerce.Controllers.V1 {
    ...
    public class CategoryController : ControllerBase {
        ...
        [Obsolete("Este metodo está absoleto. Use getCategoriesOrderByID de la version 2 en su lugar")]
        //[EnableCors(PolicyNames.AllowSpecificOrigin)] //Nivel de motodo
        public IActionResult getCategories() {

            ICollection<Category> categories = this.categoryRepository.getCategories();
